...
/**
 * Encodes a publish header packet into the supplied buffer.
 * Data must be put laiter 
 * 
 * @param buf - The buffer into which the packet will be encoded.
 * @param buf_len - The length of the specified buffer.
 * @param len - The encoded length of the packet.
 ...
 * @return An error value.
 */
uint8_t* lwmqtt_encode_only_header(uint8_t *buf, size_t buf_len, size_t *len, bool dup, uint16_t packet_id,
