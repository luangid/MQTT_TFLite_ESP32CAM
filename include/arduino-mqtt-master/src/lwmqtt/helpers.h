...
/**
 * Writes arbitrary data from the file system to the specified buffer. The pointer is incremented by the bytes written.
 *
 * @param buf - Pointer to the buffer.
 * @param buf_end - Pointer to the end of the buffer.
 * @param m_file_path - path to file.
 * @return LWMQTT_SUCCESS or LWMQTT_BUFFER_TOO_SHORT.
 */
lwmqtt_err_t lwmqtt_write_data_SD(uint8_t **buf, const uint8_t *buf_end, const char *m_file_path);
/**
